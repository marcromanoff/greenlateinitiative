...
const PointsSystemIntro = () => {
  return <>
      ...
      <p className="text-xl font-semibold mb-8 animate-fade-in" style={{ animationDelay: "100ms" }}>
        Earn Points. Climb the Leaderboard. Drive Real Change.
      </p>
      
      <div className="mb-12 bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition-all duration-300 animate-fade-in" style={{ animationDelay: "200ms" }}>
